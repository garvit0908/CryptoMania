    ...
    <Col className='coin-detail-container'>
      <Col className='coin-heading-container'>
        <Title level={2} className='coin-name'>
          ...
          <p>
            {cryptoDetails.name} live price in US dolars
          </p>
        </Title>
      </Col>
      <Select defaultValue="7d" className='select-timeperiod' 
      placeholder="Select time-period"  onChange={(value)=>setTimePeriod(value)} >
      {/* Js for selecting time period for gretting the data*/}
      {time.map((date)=><Option key={date}>{date}</Option> )}
      </Select>
      <LineChart coinHistory={coinHistory} currentPrice={millify(cryptoDetails.price)} coinName={cryptoDetails.price}/>
      ...
      <Col className='stats-container'>
        <Col className='coin-value-statistics'>
          <Col className='coin-value-heading'>
            ...
            <p>
              Detailed Overview of Stats of {cryptoDetails.name}
            </p>
          </Col>
        ...
        <Col className='coin-value-statistics'>
          <Col className='coin-value=statistics-heading'>
            ...
            <p>
              Detailed Overview of Stats of other general cryptos
            </p>
          </Col>
